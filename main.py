...
from model import TextBackbone, FGM
...
if __name__ == "__main__":
    ...
    model.load_state_dict(torch.load("./output/sup_epoch_18.pt"))
    # model = torch.load("./output/sup_epoch_20.pt")
